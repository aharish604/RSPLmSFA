package com.rspl.sf.msfa.ui.fabTnsfmgToolBar;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if(fabDrawableAnimationEnabled) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                transitionDrawable = new TransitionDrawable(new Drawable[]{tempDrawable, getResources().getDrawable(R.drawable.fab_toolbar_empty_drawable, getContext().getTheme())});
            } else {
                transitionDrawable = new TransitionDrawable(new Drawable[]{tempDrawable, getResources().getDrawable(R.drawable.fab_toolbar_empty_drawable)});
            }
