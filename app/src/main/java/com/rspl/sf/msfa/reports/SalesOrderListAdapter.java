...
public class SalesOrderListAdapter extends RecyclerView.Adapter<SalesOrderListViewHolder> {
    ...
    public SalesOrderListAdapter(Context mContext, List<SalesOrderBean> SalesOrderBeanList) {
    ...
    @Override
    public SalesOrderListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.invoice_history_item_list, parent, false);
        return new SalesOrderListViewHolder(view);
    }

    @Override
    public void onBindViewHolder(SalesOrderListViewHolder holder, final int position) {
        ...
        holder.invAmount.setText(UtilConstants.removeLeadingZerowithTwoDecimal(SalesOrderBean.getTotalAmt()) + " " + SalesOrderBean.getCurrency());
