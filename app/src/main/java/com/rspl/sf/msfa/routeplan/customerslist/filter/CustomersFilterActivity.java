...
public class CustomersFilterActivity extends AppCompatActivity implements CustomersFilterView, DateFilterFragment.OnFragmentInteractionListener {
    ...
    private CustomersFilterModelImpl filterModel;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customers_filter);
        toolbar = (Toolbar) findViewById(R.id.toolbar);
        ConstantsUtils.initActionBarView(this, toolbar, true, getString(R.string.customers_filter), 0);
        ...
        initUI();
        //other filter type
//        filterModel = new CustomersFilterModelImpl(CustomersFilterActivity.this, this);
        filterModel.onStart();
    }
    ...
    public void displayList(ArrayList<ConfigTypesetTypesBean> configTypesetTypesBeen, ArrayList<ConfigTypesetTypesBean> configTypesetDeliveryList) {
        displayStatusList(CustomersFilterActivity.this, configTypesetTypesBeen);
//        displayOverDueStatusList(CustomersFilterActivity.this, configTypesetDeliveryList);
    }
    ...
    public void showMessage(String message) {
        ConstantsUtils.displayLongToast(CustomersFilterActivity.this, message);
    }

    @Override
    public void showProgressDialog() {
        progressDialog = ConstantsUtils.showProgressDialog(CustomersFilterActivity.this, getString(R.string.app_loading));
    }
