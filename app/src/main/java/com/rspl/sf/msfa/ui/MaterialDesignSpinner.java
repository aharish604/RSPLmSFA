...
public class MaterialDesignSpinner extends AppCompatSpinner implements ValueAnimator.AnimatorUpdateListener {

    public static final int DEFAULT_ARROW_WIDTH_DP = 12;

    private static final String TAG = MaterialDesignSpinner.class.getSimpleName();
    ...
    */
    ...
    public MaterialDesignSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);

    }

    public MaterialDesignSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    */
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.MaterialDesignSpinner);
        baseColor = array.getColor(R.styleable.MaterialDesignSpinner_ms_baseColor, defaultBaseColor);
        highlightColor = array.getColor(R.styleable.MaterialDesignSpinner_ms_highlightColor, defaultHighlightColor);
        errorColor = array.getColor(R.styleable.MaterialDesignSpinner_ms_errorColor, defaultErrorColor);
        disabledColor = context.getResources().getColor(R.color.disabled_color);
        error = array.getString(R.styleable.MaterialDesignSpinner_ms_error);
        hint = array.getString(R.styleable.MaterialDesignSpinner_ms_hint);
        hintColor = array.getColor(R.styleable.MaterialDesignSpinner_ms_hintColor, baseColor);
        hintTextSize = array.getDimension(R.styleable.MaterialDesignSpinner_ms_hintTextSize, -1);
        floatingLabelText = array.getString(R.styleable.MaterialDesignSpinner_ms_floatingLabelText);
        floatingLabelColor = array.getColor(R.styleable.MaterialDesignSpinner_ms_floatingLabelColor, baseColor);
        multiline = array.getBoolean(R.styleable.MaterialDesignSpinner_ms_multiline, true);
        minNbErrorLines = array.getInt(R.styleable.MaterialDesignSpinner_ms_nbErrorLines, 1);
        alignLabels = array.getBoolean(R.styleable.MaterialDesignSpinner_ms_alignLabels, true);
        thickness = array.getDimension(R.styleable.MaterialDesignSpinner_ms_thickness, 1);
        thicknessError = array.getDimension(R.styleable.MaterialDesignSpinner_ms_thickness_error, 2);
        arrowColor = array.getColor(R.styleable.MaterialDesignSpinner_ms_arrowColor, baseColor);
        arrowSize = array.getDimension(R.styleable.MaterialDesignSpinner_ms_arrowSize, dpToPx(DEFAULT_ARROW_WIDTH_DP));
        enableErrorLabel = array.getBoolean(R.styleable.MaterialDesignSpinner_ms_enableErrorLabel, true);
        enableFloatingLabel = array.getBoolean(R.styleable.MaterialDesignSpinner_ms_enableFloatingLabel, true);
        alwaysShowFloatingLabel = array.getBoolean(R.styleable.MaterialDesignSpinner_ms_alwaysShowFloatingLabel, false);
        isRtl = array.getBoolean(R.styleable.MaterialDesignSpinner_ms_isRtl, false);
        mHintView = array.getResourceId(R.styleable.MaterialDesignSpinner_ms_hintView, android.R.layout.simple_spinner_item);
        mDropDownHintView = array.getResourceId(R.styleable.MaterialDesignSpinner_ms_dropDownHintView, android.R.layout.simple_spinner_dropdown_item);
        isHintSelectable = array.getBoolean(R.styleable.MaterialDesignSpinner_ms_isHintSelectable, true);

        String typefacePath = array.getString(R.styleable.MaterialDesignSpinner_ms_typeface);
    ...
    public void setSelection(final int position) {
        this.post(new Runnable() {
            @Override
            public void run() {
                MaterialDesignSpinner.super.setSelection(position);
//                MaterialDesignSpinner.super.setSelection(hint != null ? position + 1 : position);
            }
        });
    }
    ...
    */
    ...
    private class HintAdapter extends BaseAdapter {
        ...
        public void setHintSelectable(boolean isHintSelectabl) {
            isHintSelectable = isHintSelectabl;
            invalidate();
        }
        ...
        private View getHintView(final View convertView, final ViewGroup parent, final boolean isDropDownView) {
            ...
            textView.setTextColor(MaterialDesignSpinner.this.isEnabled() ? hintColor : disabledColor);
