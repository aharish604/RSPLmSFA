...
public class DeviceExpenseListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_device_expense_details, container, false);
    ...
    void getExpenseList() {
        ...
        alExpense.clear();
        try {
            alExpense = OfflineManager.getExpenseListDevice(getActivity());
...
//        alExpense.add(new ExpenseBean("1702100001","10/02/2017", "Travel","Approval Pending", "565", "1,285.00"));
        ...
        rvexpenseList.setAdapter(new DeviceExpenseListFragment.ExpenseListAdapter(alExpense, getActivity(), tvEmptyListLay));
    }


    public class ExpenseListAdapter extends RecyclerView.Adapter<DeviceExpenseListFragment.ExpenseListAdapter.ViewHolder> {
        ...
        @Override
        public DeviceExpenseListFragment.ExpenseListAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_expense_list, viewGroup, false);
            return new DeviceExpenseListFragment.ExpenseListAdapter.ViewHolder(view);
        }

        @Override
        public void onBindViewHolder(DeviceExpenseListFragment.ExpenseListAdapter.ViewHolder viewHolder, int i) {
            ...
            viewHolder.llExpenseItemLay.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intentDCRDetails.putExtra("from","expense list device");
