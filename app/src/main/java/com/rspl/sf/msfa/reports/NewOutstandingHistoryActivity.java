...
import com.rspl.sf.msfa.adapter.NewOutstandingListAdapter;
...
public class NewOutstandingHistoryActivity extends AppCompatActivity implements View.OnClickListener, UIListener {


    private NewOutstandingListAdapter outstandingListAdapter = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_out_standing);
...
//                    + Constants.PaymentStatusID + " ne '" + "03" + "'", getApplicationContext(), "", mStrBundleCPGUID);
        ...
        spOutstandingStatus.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View arg1,
                ...
                new NewOutstandingHistoryActivity.LoadData(NewOutstandingHistoryActivity.this).execute();
    ...
    private void getInvoiceList(String status) {
        try {
            ...
            if (status.equalsIgnoreCase("")) {
                alOutstandingsBean = OfflineManager.getNewOutstandingList(Constants.OutstandingInvoiceItems
...
//                NewOutstandingHistoryActivity.this.outstandingListAdapter = new OutstandingListAdapter(NewOutstandingHistoryActivity.this, R.layout.activity_invoice_history_list,
...
//                NewOutstandingHistoryActivity.this.outstandingListAdapter.notifyDataSetChanged();
...
//            tvTotalOutValCurr.setText(currencyText);
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(NewOutstandingHistoryActivity.this, R.style.MyTheme);
        builder.setMessage(R.string.alert_exit_competition_information).setCancelable(false)
                .setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        dialog.cancel();
                        NewOutstandingHistoryActivity.this.finish();
                    }
                })
    ...
    void onRefresh() {
        ...
        if (UtilConstants.isNetworkAvailable(getApplicationContext())) {
            ...
            alAssignColl.add(Constants.OutstandingInvoiceItems);
            ...
            try {
                ...
                new NewOutstandingHistoryActivity.LoadingData().execute();
            } catch (Exception e) {
                e.printStackTrace();
            }
        }else{
            UtilConstants.showAlert(getString(R.string.no_network_conn),NewOutstandingHistoryActivity.this);
        }
    ...
    public class LoadingData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            syncProgDialog = new ProgressDialog(NewOutstandingHistoryActivity.this, R.style.ProgressDialogTheme);
                    ...
                    .setOnCancelListener(new DialogInterface.OnCancelListener() {
                        ...
                        public void onCancel(DialogInterface Dialog) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(
                                    NewOutstandingHistoryActivity.this, R.style.MyTheme);
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                try {
                    ...
                    OfflineManager.refreshStoreSync(getApplicationContext(), NewOutstandingHistoryActivity.this, Constants.Fresh, concatCollectionStr);
                } catch (OfflineODataStoreException e) {
                    e.printStackTrace();
                }
    ...
    public void onRequestError(int operation, Exception e) {
        ErrorBean errorBean = Constants.getErrorCode(operation, e, NewOutstandingHistoryActivity.this);
        if (errorBean.hasNoError()) {
                ...
                if (operation == Operation.OfflineRefresh.getValue()) {
                  ...
                  //      Constants.updateSyncTime(alAssignColl,this,Constants.DownLoad);
                    ...
                    if (!Constants.isStoreClosed) {
                        UtilConstants.showAlert(getString(R.string.msg_error_occured_during_sync), NewOutstandingHistoryActivity.this);
                    } else {
                        UtilConstants.showAlert(getString(R.string.msg_sync_terminated), NewOutstandingHistoryActivity.this);
                    }
                }
            }
        } else {
            Constants.isSync = false;
            syncProgDialog.dismiss();
            Constants.displayMsgReqError(errorBean.getErrorCode(), NewOutstandingHistoryActivity.this);
        }
    }
    ...
    class LoadData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            NewOutstandingHistoryActivity.this.outstandingListAdapter = new NewOutstandingListAdapter(NewOutstandingHistoryActivity.this,
