...
public class NewInvoiceHisListAdapter extends ArrayAdapter<InvoiceHistoryBean> {
    ...
    public NewInvoiceHisListAdapter(Context context, int textViewResourceId,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = vi.inflate(R.layout.new_invoice_history_item_list, null);
        }
        ...
        if (lb != null) {
            ...
            TextView tv_material_number = (TextView) v.findViewById(R.id.tv_material_number);
            ...
            tv_material_number.setText(lb.getMatDesc());
            tv_quantity.setText(lb.getInvoiceQuantity()+" "+lb.getUom());
