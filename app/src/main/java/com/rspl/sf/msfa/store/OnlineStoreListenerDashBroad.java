...
public class OnlineStoreListenerDashBroad implements OnlineODataStore.OpenListener {
    public static OnlineStoreListenerDashBroad instance;

    private final CountDownLatch latch = new CountDownLatch(1);
    OnlineODataStore store;
    Exception error;
    private OnlineStoreListenerDashBroad() {
    }

    public static OnlineStoreListenerDashBroad getInstance() {
        if (instance == null) {
            instance = new OnlineStoreListenerDashBroad();
        }
        return instance;
    }
    ...
    public void storeOpened(OnlineODataStore store) {
        ...
        //latch.countDown();
        LogManager.writeLogInfo("Online DashBoard store opened successfully");
    }
