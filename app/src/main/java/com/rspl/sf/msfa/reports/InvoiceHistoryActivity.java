...
// *
// */
//public class InvoiceHistoryActivity extends AppCompatActivity implements UIListener {
//
...
//
//                alInvoiceBean = OfflineManager.getInvoiceHistoryList(Constants.SFINVOICES+"?$filter="+ Constants.CustomerNo+" eq '"+mStrBundleRetID+"' " +
...
//            }
//
//            InvoiceHistoryActivity.this.invoiceHisListAdapter = new InvoiceHisListAdapter( InvoiceHistoryActivity.this, R.layout.activity_invoice_history_list,alInvoiceBean,bundleExtras);
//            lv_inv_his_list.setEmptyView(findViewById(R.id.tv_empty_lay) );
//            lv_inv_his_list.setAdapter(invoiceHisListAdapter);
//            InvoiceHistoryActivity.this.invoiceHisListAdapter.notifyDataSetChanged();
//
...
//        ErrorBean errorBean = Constants.getErrorCode(operation, e, InvoiceHistoryActivity.this);
...
//
//                    } else {
//                        UtilConstants.showAlert(getString(R.string.msg_sync_terminated), InvoiceHistoryActivity.this);
//                    }
//                }
//            }
//        } else {
