...
/**
 * Created by ccb on 12-08-2017.
 */

public class MustSellActivity extends AppCompatActivity {


    ArrayList<Config> visitMatList;
    ListView lv_must_sell_list = null;
    TextView tvRetName = null, tvUID = null, tv_must_sell_header =null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_must_sell_product_list);
...
//        ActionBarView.initActionBarView(this, true,mStrDescription);
    ...
    private void initUI() {
        ...
        tv_must_sell_header = (TextView) findViewById(R.id.tv_mustsell_product_header);
        lv_must_sell_list = (ListView)findViewById(R.id.lv_must_sell_list);
...
//                + Constants.SegmentId + " eq '" + mStrStatus + "' &$orderby=" + Constants.MaterialDesc + "%20asc";
        ...
        String mStrFocusedProductQry = Constants.SegmentedMaterials;
        try {
    ...
    private void setValuesIntoUI(){
       // tv_last_sync_time_value.setText(Constants.getLastSyncTime(Constants.SYNC_TABLE,Constants.Collections,Constants.SegmentedMaterials,Constants.TimeStamp,this));
        ...
        tv_must_sell_header.setText(mStrDescription);
    ...
    private void loadAdapter(){
        ...
        lv_must_sell_list.setEmptyView(findViewById(R.id.tv_empty_lay) );
        lv_must_sell_list.setAdapter(newMustSellAdapter);
